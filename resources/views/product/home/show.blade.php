...
<head>
    <meta charset="utf-8">
    <title>Detail du produit {{ $product->name }}</title>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Detail du produit</span>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-95 h-100" src="/images/{{ $product->image }}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">{{ $product->prix }} fcfa</h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Ajouter au pannier</button>
                    </div>
                    <div class="d-flex pt-2">
                        <strong class="text-dark mr-2">Partagé:</strong>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Information Additionnelle</h4>
